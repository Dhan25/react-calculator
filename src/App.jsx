...
function App() {
  ...
  const deleteAll = () => setResult(result.slice(0, -1));
  ...
  return (
    <div className="calculator">
      ...
      <div className="buttons">
        ...
        <button className="operator bg-[#D4D4D2] font-semibold" onClick={deleteAll}>
          DE
        </button>

        <button id="." className="operator bg-[#D4D4D2] font-bold" onClick={handleClick}>
          .
        </button>
        ...
        <button id="=" className="operator w-[136px] rounded-lg" onClick={calculate}>
          =
        </button>
      </div>
    </div>
